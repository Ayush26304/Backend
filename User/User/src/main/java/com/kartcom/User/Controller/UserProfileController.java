...
public class UserProfileController {
    ...
    public ResponseEntity<String> createMinimalProfile(@RequestBody MinimalProfileDto dto) {
        service.createMinimalProfile(dto);
        return ResponseEntity.ok("Minimal profile created successfully");
    }
